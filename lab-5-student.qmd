...
```{r}
#| label: load-data
teacher <- read_csv("teacher_evals.csv")
...
# most of the data consists of dbl and chr types. There are 8,015 rows of data and 22 columns. The data is not uniform, for example, the course ID could be changed to BHP. And NAs should be added or removed for the zero values.
...
# the column type (dbl and chr) shows the unit of observation
select(teacher, time_of_day, class_duration)
